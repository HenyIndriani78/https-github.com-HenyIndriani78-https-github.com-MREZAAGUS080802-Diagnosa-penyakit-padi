...
<div class="container-fluid text-center">    
  <div class="row content">
    <div class="col-sm-2 sidenav">
      ...
      <p><a href="diagnosa.php"><button type="button" class="btn btn-primary btn-block">DIAGNOSA PENYAKIT PADI</button></a></p>
    ...
    <div class="col-sm-8 text-left"> 
      ...
      <div class="panel-body">
          M. Reza Agustiyani<br>
          Melinda Ainun wulandari<br>
          Ratu ifalla yusuf<br>
          Nur Aeni<br>
          fajar fauadi<br>
          </div>
    </div>
